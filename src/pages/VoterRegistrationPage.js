...
const VoterRegistrationPage = ({ account, showAlert }) => {
  ...
  console.log("props45654126511", props);
  ...
  console.log("defaultValuedasdadsdas", defaultValues);
          ...
          <Card sx={{ p: 3, mt: 1, mb: 2 }}>
            ...
            >
              <Grid item xs={12} md={6} lg={6}>
                ...
                <RHFTextField name="is_newregistration" label="Voter Type?" select disabled={props?.voterData != null}>
