...
import VotingSurveyReportsPage from "./pages/VotingPollSurveyReportsPage";
...
import VotingPollSurveyReportsPage from "./pages/VotingPollSurveyReportsPage";
import CmLoginPage from "./pages/CmLoginPage";
import ClusterGroupsPage from "./pages/ClusterGroupsPage";
...
const Router = () => {
  return (
    <Routes>
      ...
      <Route path="/login" element={<CmLoginPage />} />
      ...
      <Route path="/" element={<ProtectedRoute type={[LOGIN_TYPES[0], LOGIN_TYPES[7]]} />}>
        <Route path="" element={<DashboardLayout />}>
          ...
          <Route path="/voting-poll-survey/reports" element={<VotingPollSurveyReportsPage />} />
      ...
      <Route path="/" element={<ProtectedRoute type={[LOGIN_TYPES[0], LOGIN_TYPES[7], LOGIN_TYPES[8]]} />}>
        <Route path="" element={<DashboardLayout />}>
          ...
          <Route path="groups" element={<ClusterGroupsPage />} />
        </Route>
      </Route>
